# This Makefile is for the Bio::Tools::Alignment::Overview extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Bio/Tools/Alignment/Overview.pm]
...
MAN3EXT = 3pm
INSTALLDIRS = site
INSTALL_BASE = /home/leprevost/perl5
DESTDIR = 
PREFIX = $(INSTALL_BASE)
...
MAKEMAKER   = /home/leprevost/perl5/lib/perl5/ExtUtils/MakeMaker.pm
MM_VERSION  = 6.98
MM_REVISION = 69800
...
MAKE = make
FULLEXT = Bio/Tools/Alignment/Overview
BASEEXT = Overview
PARENT_NAME = Bio::Tools::Alignment
DLBASE = $(BASEEXT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Bio/Tools/Alignment/Overview.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Bio/Tools/Alignment
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Bio/Tools/Alignment
...
TO_INST_PM = lib/Bio/Tools/Alignment/Overview.pm

PM_TO_BLIB = lib/Bio/Tools/Alignment/Overview.pm \
	blib/lib/Bio/Tools/Alignment/Overview.pm
...
DISTVNAME = Bio-Tools-Alignment-Overview-0.32
...
manifypods : pure_all  \
	lib/Bio/Tools/Alignment/Overview.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Bio/Tools/Alignment/Overview.pm $(INST_MAN3DIR)/Bio::Tools::Alignment::Overview.$(MAN3EXT) 
...
clean :: clean_subdirs
	- $(RM_F) \
	  ...
	  *perl.core MYMETA.json \
	  ...
	  tmon.out 
	- $(RM_RF) \
	  Bio-Tools-Alignment-Overview-* blib 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''just another represetation for biological sequence alignment.'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '  - '\''Leprevost <leprevostfv@gmail.com>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Bio-Tools-Alignment-Overview' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "just another represetation for biological sequence alignment.",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "Leprevost <leprevostfv@gmail.com>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Bio-Tools-Alignment-Overview",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '         "requires" : {' >> META_new.json
	$(NOECHO) $(ECHO) '            "GD::Simple" : "0",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>just another represetation for biological sequence alignment.</ABSTRACT>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Bio/Tools/Alignment/Overview.pm blib/lib/Bio/Tools/Alignment/Overview.pm 
